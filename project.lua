local project = new_project("GPS Redux", "CPP")
project:output("SA.GPS.REDUX.asi")

project:file(filesystem:walk("src", true, {"cpp"}))
project:asset("README.md", "README.md")
project:asset("SA.GPS.CONF.ini", "SA.GPS.CONF.ini")
